function Login (){
    return(
        <div className="flex flex-col items-center justify-center h-screen w-full bg-background p-5">
            <main className=" bg-light flex flex-col items-center justify-center rounded-xl shadow-lg p-5 w-full max-w-100 relative overflow-hidden">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-principal bg-principal/10 p-2 w-13 h-13 rounded-2xl my-5">
                ...
                <p className="text-dark/70 ">Please enter your details to sign in</p>
